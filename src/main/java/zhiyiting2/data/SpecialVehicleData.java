...
import zhiyiting2.test.parkingManagement.service.impl.SpecialVehicleServiceImpl;
...
public class SpecialVehicleData {
	...
	public Object[][] updateSpecialCar() {
		...
		try {
	       ...
	       return new Object[][]{
	               {"编辑路边免费车辆:",SpecialVehicleServiceImpl.specialCarId,this.specialCar,0,validStart,validEnd},
	...
	public Object[][] deleteSpecialCar() {
	       return new Object[][]{
	               {"删除路边免费车辆:",SpecialVehicleServiceImpl.specialCarId},
