package zhiyiting2.test.parkingManagement;
 ...
 *
 */
public class SpecialVehicle extends ZTest{
	@Autowired
	...
	public void addSpecialCar(String testname,String plateNo,int isEnable,Date validStart,Date validEnd) throws Exception {
		Map map = new HashMap();
	...
	public void updateSpecialCar(String testname,int id,String plateNo,int isEnable,Date validStart,Date validEnd) throws Exception {
		Map map = new HashMap();
		map.put("id", id);
		map.put("plateNo", plateNo);
		map.put("isEnable", isEnable);
	...
	public void deleteSpecialCar(String testname,Integer id) throws Exception {
		Map map = new HashMap();
		map.put("id", id);
